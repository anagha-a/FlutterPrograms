...
class loginScreen extends StatefulWidget {
  ...
  static const String idScreen = "loginscreen"; //to easily identify 
...
// reg
  ...
  //             log ("hello"+auth.toString());
  //     final User? firebaseUser = auth.user;
  //         log ("hi"+firebaseUser.toString());
  ...
  //       log(adminDataMap.toString());
  //       try{
  //         DatabaseReference adminRef = FirebaseDatabase.instance.ref().child("admin");
  //          await adminRef.child(firebaseUser.uid).set(adminDataMap);
  //       }
  //       catch(e){
  //         log("ERRRO"+e.toString());
  //       }
  ...
  //     } else {
  //       Navigator.pop(context);
  //       redMessenger(context, "New user account not created");
  //     }
