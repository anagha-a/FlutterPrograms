...
import 'package:sqflite_db/sql_helper.dart';

void main(){
  runApp(MaterialApp(home: Sqldb(),debugShowCheckedModeBanner: false,theme: ThemeData(primarySwatch: Colors.deepOrange),));
}

class Sqldb extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _SqldbState();
